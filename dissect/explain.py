...
class ExplainEngine:
    ...
    SYSTEM_PROMPT = """
You are Dissect, an expert AI Agent Architect. Your task is to analyze an agent orchestration trace and provide a concise, professional summary.
...
def explain_graph(graph: OrchestrationGraph, provider: str = "openai", model: Optional[str] = None) -> str:
