...
from dissect.explain import ExplainEngine
from dissect.graph import Node, NodeType, OrchestrationGraph
...
class TestExplainEngine(unittest.TestCase):
    ...
    def test_explain_openai(self, mock_post):
        ...
        mock_response.json.return_value = {"choices": [{"message": {"content": "Test Insight"}}]}
    ...
    def test_explain_ollama(self, mock_post):
        ...
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"message": {"content": "Ollama Insight"}}
        mock_post.return_value = mock_response
